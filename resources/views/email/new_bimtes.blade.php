                        ...
                        <tr>
                          <td class="column_cell font_default" align="center" valign="top" style="padding: 16px;font-family: Helvetica, Arial, sans-serif;font-size: 15px;text-align: center;vertical-align: top;color: #888888;">
                            ...
                            <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 5px;margin-bottom: 24px;"><strong>Password</strong><br>
                              ...
                              <a href="https://www.ponpesalihsancbr.id/in/bimtes/login" style="padding-top: 5px;padding-bottom: 5px; background-color: #22aaa0;display: block;text-decoration: none;font-family: Helvetica, Arial, sans-serif;color: #ffffff;font-weight: bold;text-align: center;"><span style="text-decoration: none;color: #ffffff;text-align: center;display: block;">Start your first campaign</span></a>
                          </td><!-- /.column_cell -->
                        </tr>
                      </tbody>
                    </table><!-- /.column -->
                    ...
                    <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;vertical-align: top;">
                      <tbody>
                        <tr>
                          ...
                          <small style="font-size: 86%;font-weight: normal;">this email was sent by <a href="#" style="display: inline-block;text-decoration: none;font-family: Helvetica, Arial, sans-serif;color: #7a7a7a;">noreply@ponpesalihsancbr.id</a>, <br>please do not reply to this email. <br>
