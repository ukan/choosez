  ...
  <div class="modal fade modal-getstart" id="modalFormBulletinBoard" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div style="min-width:1027px;" class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
        {!! Form::open(['route'=>'admin-post-bulletin-board-editor', 'files'=>true, 'class' => 'form-horizontal jquery-form-bulletin-board']) !!}
                <input type="hidden" name="action" id="action" value="">      
                <input type="hidden" name="bulletin_board_id" value=""> 
                <div class="form-group area-insert-update hidden">
                    {!! Form::label('type', 'Type', array('class' => 'col-lg-3 control-label')) !!}
                    <div class="col-lg-9">
                        <select id="type" name="type" class="select2" style="width:100px">
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#bulletin-boards-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! route('datatables-bulletin-boards-editor') !!}",
                order: [[ 1, 'desc' ]],
                columns: [
