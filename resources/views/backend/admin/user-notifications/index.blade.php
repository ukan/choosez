...
@section('header')
    ...
    <style>
        ...
        {!! Html::style($pathp.'assets/backend/porto-admin/vendor/bootstrap-timepicker/css/bootstrap-timepicker.css') !!}
...
@section('scripts')
    ...
    {!! Html::script($pathp.'assets/plugins/bootstrap-validator/bootstrap-validator.js') !!}
    {!! Html::script($pathp.'assets/general/library/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') !!}
    {!! Html::script($pathp.'assets/general/library/tableExport.jquery.plugin/tableExport.js') !!}
    {!! Html::script($pathp.'assets/general/library/tableExport.jquery.plugin/jquery.base64.js') !!}
