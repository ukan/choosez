            ...
            <table id="data-tables" class="table table-hover table-bordered table-condensed table-responsive" data-tables="true">
                <thead>
                    <tr>
                        ...
                        <th class="center-align" width="20%">Image</th>
  ...
  <div class="modal fade modal-getstart" id="modalFormData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        {!! Form::open(['route'=>'admin-post-photo', 'files'=>true, 'class' => 'form-horizontal jquery-form-data']) !!}
                ...
                <div class="form-group area-insert-update">
                    ...
                    <div class="col-lg-9">
                        <select name="album_name" class="select2" style="width:100px">
                            <option value="Select Album">Select Album</option>
                            @foreach($album as $key => $value)
                                <option value="{{ $value->id}}">{{ $value->name}}</option>
                            @endforeach
                        </select>
                        <p class="has-error text-danger error-album_name"></p>
                    </div>
                    <div class="clear"></div>
                </div>
...
@section('scripts')
    ...
    <script>
        ...
        function show_form_create(){
            $('.FormData-title').html('Upload Image');
        ...
        function show_form_delete(id){
            ...
            $('.area-delete').show();
            $('.FormData-title').html('Delete Image');
